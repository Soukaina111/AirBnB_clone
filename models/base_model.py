...
class BaseModel:
    ...
    def __init__(self, *args, **kwargs):
        ...
        If kwargs is empty:
            - The id and created_at attributes are created as in the previous implementation.
        """
        if kwargs:
    ...
    def __str__(self):
        ...
        Returns:
            str: A string representation in the format [<class name>] (<id>) <__dict__>.
        """
    ...
    def to_dict(self):
        ...
        Returns:
            dict: A dictionary containing all keys/values of __dict__ of the instance.
                  The dictionary includes the __class__ key with the class name and converts the created_at
                  and updated_at attributes to ISO format (%Y-%m-%dT%H:%M:%S.%f).
        """
